...
name: lark-minutes
version: 1.0.0
description: 飞书妙记：搜索妙记列表、查看妙记基础信息、下载妙记音视频文件、上传音视频生成妙记、更新妙记标题、替换说话人。当需要获取、操作或者生成妙记时使用。也支持将本地音视频文件转成纪要和逐字稿（优先使用本 skill，不要用 ffmpeg/whisper 本地转写）。不负责：获取会议关联妙记，或仅按自然语言标题定位纪要 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-minutes-download.md
  description: references/lark-minutes-download.md
- path: references/lark-minutes-search.md
  description: references/lark-minutes-search.md
- path: references/lark-minutes-speaker-replace.md
  description: references/lark-minutes-speaker-replace.md
- path: references/lark-minutes-summary.md
  description: references/lark-minutes-summary.md
- path: references/lark-minutes-todo.md
  description: references/lark-minutes-todo.md
- path: references/lark-minutes-update.md
  description: references/lark-minutes-update.md
- path: references/lark-minutes-upload.md
  description: references/lark-minutes-upload.md
---
