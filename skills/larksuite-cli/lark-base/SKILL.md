...
name: lark-base
version: 1.2.2
description: 飞书多维表格（Base）操作：建表、字段、记录、视图、统计、公式/lookup、表单、仪表盘、workflow、角色权限；遇到 Base/多维表格/bitable 或 /base/ 链接时使用。文件导入转 lark-drive，认证/授权转 lark-shared。 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/dashboard-block-data-config.md
  description: references/dashboard-block-data-config.md
- path: references/formula-field-guide.md
  description: references/formula-field-guide.md
- path: references/lark-base-cell-value.md
  description: references/lark-base-cell-value.md
- path: references/lark-base-dashboard-block-get-data.md
  description: references/lark-base-dashboard-block-get-data.md
- path: references/lark-base-dashboard.md
  description: references/lark-base-dashboard.md
- path: references/lark-base-data-analysis-sop.md
  description: references/lark-base-data-analysis-sop.md
- path: references/lark-base-data-query-guide.md
  description: references/lark-base-data-query-guide.md
- path: references/lark-base-data-query.md
  description: references/lark-base-data-query.md
- path: references/lark-base-field-create.md
  description: references/lark-base-field-create.md
- path: references/lark-base-field-json.md
  description: references/lark-base-field-json.md
- path: references/lark-base-field-update.md
  description: references/lark-base-field-update.md
- path: references/lark-base-form-detail.md
  description: references/lark-base-form-detail.md
- path: references/lark-base-form-questions-create.md
  description: references/lark-base-form-questions-create.md
- path: references/lark-base-form-questions-update.md
  description: references/lark-base-form-questions-update.md
- path: references/lark-base-form-submit.md
  description: references/lark-base-form-submit.md
- path: references/lark-base-record-batch-create.md
  description: references/lark-base-record-batch-create.md
- path: references/lark-base-record-batch-update.md
  description: references/lark-base-record-batch-update.md
- path: references/lark-base-record-history-list.md
  description: references/lark-base-record-history-list.md
- path: references/lark-base-record-upsert.md
  description: references/lark-base-record-upsert.md
- path: references/lark-base-role-guide.md
  description: references/lark-base-role-guide.md
- path: references/lark-base-view-set-filter.md
  description: references/lark-base-view-set-filter.md
- path: references/lark-base-workflow-guide.md
  description: references/lark-base-workflow-guide.md
- path: references/lark-base-workflow-schema.md
  description: references/lark-base-workflow-schema.md
- path: references/lookup-field-guide.md
  description: references/lookup-field-guide.md
- path: references/role-config.md
  description: references/role-config.md
---
