...
type: default
references:
- path: references/asset-planning.md
  description: references/asset-planning.md
- path: references/examples.md
  description: references/examples.md
- path: references/iconpark-index.json
  description: references/iconpark-index.json
- path: references/iconpark.md
  description: references/iconpark.md
- path: references/lark-slides-create.md
  description: references/lark-slides-create.md
- path: references/lark-slides-edit-workflows.md
  description: references/lark-slides-edit-workflows.md
- path: references/lark-slides-media-upload.md
  description: references/lark-slides-media-upload.md
- path: references/lark-slides-replace-slide.md
  description: references/lark-slides-replace-slide.md
- path: references/lark-slides-screenshot.md
  description: references/lark-slides-screenshot.md
- path: references/lark-slides-whiteboard.md
  description: references/lark-slides-whiteboard.md
- path: references/lark-slides-xml-presentation-slide-create.md
  description: references/lark-slides-xml-presentation-slide-create.md
- path: references/lark-slides-xml-presentation-slide-delete.md
  description: references/lark-slides-xml-presentation-slide-delete.md
- path: references/lark-slides-xml-presentation-slide-get.md
  description: references/lark-slides-xml-presentation-slide-get.md
- path: references/lark-slides-xml-presentation-slide-replace.md
  description: references/lark-slides-xml-presentation-slide-replace.md
- path: references/lark-slides-xml-presentations-get.md
  description: references/lark-slides-xml-presentations-get.md
- path: references/planning-layer.md
  description: references/planning-layer.md
- path: references/slide-templates.md
  description: references/slide-templates.md
- path: references/slides_demo.xml
  description: references/slides_demo.xml
- path: references/slides_xml_schema_definition.xml
  description: references/slides_xml_schema_definition.xml
- path: references/template-catalog.md
  description: references/template-catalog.md
- path: references/template-index.json
  description: references/template-index.json
- path: references/troubleshooting.md
  description: references/troubleshooting.md
- path: references/validation-checklist.md
  description: references/validation-checklist.md
- path: references/visual-planning.md
  description: references/visual-planning.md
- path: references/xml-format-guide.md
  description: references/xml-format-guide.md
- path: references/xml-schema-quick-ref.md
  description: references/xml-schema-quick-ref.md
---
...
```bash
SKILL_DIR="$PWD/skills/larksuite-cli/lark-slides"
mkdir -p artifacts/lark_work/<unique-task-name>
uv run --frozen python "$SKILL_DIR/scripts/template_tool.py" search --query "<用户需求原文>" --limit 3
uv run --frozen python "$SKILL_DIR/scripts/template_tool.py" summarize --template <template-id> --label <封面|目录|分节|内容|结尾>
uv run --frozen python "$SKILL_DIR/scripts/template_tool.py" extract --template <template-id> --label <页型> --out artifacts/lark_work/<unique-task-name>/template-slice.xml
```
