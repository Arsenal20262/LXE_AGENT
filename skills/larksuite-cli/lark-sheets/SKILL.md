...
name: lark-sheets
version: 2.0.0
description: 飞书电子表格：创建和操作电子表格。支持创建表格、管理工作表与行列结构（增删/合并/调整尺寸/隐藏/冻结）、读写单元格（值/公式/样式/批注/单元格图片）、查找替换、多操作原子批量更新，以及图表、透视表、条件格式、筛选器、迷你图、浮动图片等对象的创建与维护。当用户需要创建电子表格、管理工作表、批量读写或编辑数据、统计汇总与可视化、表格美化、公式计算（含 Excel 公式迁移）等任务时使用。若用户是想按名称或关键词搜索云空间（云盘/云存储）里的表格文件，请改用 lark-drive 的 drive +search 先定位资源。当用户给出 doubao.com 的 /sheets/ URL/token 时，也应直接使用本 skill，不要因为域名不是飞书而回退到 WebFetch；路由依据是 URL 路径模式和 token，而不是域名。仅针对飞书在线电子表格，不适用于本地 Excel 文件。 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-sheets-batch-update.md
  description: references/lark-sheets-batch-update.md
- path: references/lark-sheets-chart.md
  description: references/lark-sheets-chart.md
- path: references/lark-sheets-conditional-format.md
  description: references/lark-sheets-conditional-format.md
- path: references/lark-sheets-core-operations.md
  description: references/lark-sheets-core-operations.md
- path: references/lark-sheets-filter-view.md
  description: references/lark-sheets-filter-view.md
- path: references/lark-sheets-filter.md
  description: references/lark-sheets-filter.md
- path: references/lark-sheets-float-image.md
  description: references/lark-sheets-float-image.md
- path: references/lark-sheets-formula-translation.md
  description: references/lark-sheets-formula-translation.md
- path: references/lark-sheets-pivot-table.md
  description: references/lark-sheets-pivot-table.md
- path: references/lark-sheets-range-operations.md
  description: references/lark-sheets-range-operations.md
- path: references/lark-sheets-read-data.md
  description: references/lark-sheets-read-data.md
- path: references/lark-sheets-search-replace.md
  description: references/lark-sheets-search-replace.md
- path: references/lark-sheets-sheet-structure.md
  description: references/lark-sheets-sheet-structure.md
- path: references/lark-sheets-sparkline.md
  description: references/lark-sheets-sparkline.md
- path: references/lark-sheets-visual-standards.md
  description: references/lark-sheets-visual-standards.md
- path: references/lark-sheets-workbook.md
  description: references/lark-sheets-workbook.md
- path: references/lark-sheets-write-cells.md
  description: references/lark-sheets-write-cells.md
---
