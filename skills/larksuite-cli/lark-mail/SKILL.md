...
name: lark-mail
version: 1.0.0
description: 飞书邮箱：Use when user mentions 起草邮件、写邮件、草稿、发送/回复/转发邮件、查阅邮件、看邮件、搜索邮件、邮件文件夹、邮件标签、邮件联系人、监听新邮件、邮件收信规则等；use for mail/email intent only. Do not use for docs/sheets/calendar/auth setup/pure contact lookup/IM chat tasks. Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-mail-calendar-invite.md
  description: references/lark-mail-calendar-invite.md
- path: references/lark-mail-decline-receipt.md
  description: references/lark-mail-decline-receipt.md
- path: references/lark-mail-draft-create.md
  description: references/lark-mail-draft-create.md
- path: references/lark-mail-draft-edit.md
  description: references/lark-mail-draft-edit.md
- path: references/lark-mail-forward.md
  description: references/lark-mail-forward.md
- path: references/lark-mail-html.md
  description: references/lark-mail-html.md
- path: references/lark-mail-lint-html.md
  description: references/lark-mail-lint-html.md
- path: references/lark-mail-message.md
  description: references/lark-mail-message.md
- path: references/lark-mail-messages.md
  description: references/lark-mail-messages.md
- path: references/lark-mail-recall.md
  description: references/lark-mail-recall.md
- path: references/lark-mail-recipient-search.md
  description: references/lark-mail-recipient-search.md
- path: references/lark-mail-reply-all.md
  description: references/lark-mail-reply-all.md
- path: references/lark-mail-reply.md
  description: references/lark-mail-reply.md
- path: references/lark-mail-rules.md
  description: references/lark-mail-rules.md
- path: references/lark-mail-send-as.md
  description: references/lark-mail-send-as.md
- path: references/lark-mail-send-receipt.md
  description: references/lark-mail-send-receipt.md
- path: references/lark-mail-send-status.md
  description: references/lark-mail-send-status.md
- path: references/lark-mail-send.md
  description: references/lark-mail-send.md
- path: references/lark-mail-share-to-chat.md
  description: references/lark-mail-share-to-chat.md
- path: references/lark-mail-signature.md
  description: references/lark-mail-signature.md
- path: references/lark-mail-template-create.md
  description: references/lark-mail-template-create.md
- path: references/lark-mail-template-update.md
  description: references/lark-mail-template-update.md
- path: references/lark-mail-template.md
  description: references/lark-mail-template.md
- path: references/lark-mail-thread.md
  description: references/lark-mail-thread.md
- path: references/lark-mail-triage.md
  description: references/lark-mail-triage.md
- path: references/lark-mail-watch.md
  description: references/lark-mail-watch.md
---
