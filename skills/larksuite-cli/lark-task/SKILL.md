...
name: lark-task
version: 1.0.0
description: 飞书任务：管理任务、清单和任务智能体。创建待办任务、查看和更新任务状态、拆分子任务、组织任务清单、分配协作成员、上传任务附件、注册或注销任务智能体、更新任务智能体的主页数据、写入智能体任务记录。当用户需要创建待办事项、查看任务列表、跟踪任务进度、管理项目清单或给他人分配任务、为任务上传附件文件、注册注销任务智能体、更新智能体主页数据、写入任务记录时使用。 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-task-assign.md
  description: references/lark-task-assign.md
- path: references/lark-task-comment.md
  description: references/lark-task-comment.md
- path: references/lark-task-complete.md
  description: references/lark-task-complete.md
- path: references/lark-task-create.md
  description: references/lark-task-create.md
- path: references/lark-task-followers.md
  description: references/lark-task-followers.md
- path: references/lark-task-get-my-tasks.md
  description: references/lark-task-get-my-tasks.md
- path: references/lark-task-get-related-tasks.md
  description: references/lark-task-get-related-tasks.md
- path: references/lark-task-reminder.md
  description: references/lark-task-reminder.md
- path: references/lark-task-reopen.md
  description: references/lark-task-reopen.md
- path: references/lark-task-search.md
  description: references/lark-task-search.md
- path: references/lark-task-set-ancestor.md
  description: references/lark-task-set-ancestor.md
- path: references/lark-task-subscribe-event.md
  description: references/lark-task-subscribe-event.md
- path: references/lark-task-tasklist-create.md
  description: references/lark-task-tasklist-create.md
- path: references/lark-task-tasklist-members.md
  description: references/lark-task-tasklist-members.md
- path: references/lark-task-tasklist-search.md
  description: references/lark-task-tasklist-search.md
- path: references/lark-task-tasklist-task-add.md
  description: references/lark-task-tasklist-task-add.md
- path: references/lark-task-update.md
  description: references/lark-task-update.md
- path: references/lark-task-upload-attachment.md
  description: references/lark-task-upload-attachment.md
---
