...
name: lark-apps
version: 1.0.0
description: 妙搭（Spark/Miaoda）应用开发与托管：应用创建、HTML静态站点发布、本地全栈开发、云端生成迭代。当用户要开发/新建一个系统·工具·平台·应用，或要本地开发 / 云端开发 / 修改 / 部署 / 发布 / 上线 / 拿可分享链接，或用 HTML 做页面·网站·部署到妙搭，或提到妙搭/Spark/Miaoda（应用运行时域名形如 *.aiforce.cloud）、应用数据库、可见范围时使用。不负责普通云盘文件上传（lark-drive）、飞书文档编辑（lark-doc）、原生幻灯片创建（lark-slides）。 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-apps-access-scope-get.md
  description: references/lark-apps-access-scope-get.md
- path: references/lark-apps-access-scope-set.md
  description: references/lark-apps-access-scope-set.md
- path: references/lark-apps-cloud-dev.md
  description: references/lark-apps-cloud-dev.md
- path: references/lark-apps-create.md
  description: references/lark-apps-create.md
- path: references/lark-apps-db-env-create.md
  description: references/lark-apps-db-env-create.md
- path: references/lark-apps-db-execute.md
  description: references/lark-apps-db-execute.md
- path: references/lark-apps-db-table-get.md
  description: references/lark-apps-db-table-get.md
- path: references/lark-apps-db-table-list.md
  description: references/lark-apps-db-table-list.md
- path: references/lark-apps-env-pull.md
  description: references/lark-apps-env-pull.md
- path: references/lark-apps-git-credential.md
  description: references/lark-apps-git-credential.md
- path: references/lark-apps-html-publish.md
  description: references/lark-apps-html-publish.md
- path: references/lark-apps-init.md
  description: references/lark-apps-init.md
- path: references/lark-apps-list.md
  description: references/lark-apps-list.md
- path: references/lark-apps-local-dev.md
  description: references/lark-apps-local-dev.md
- path: references/lark-apps-release-create.md
  description: references/lark-apps-release-create.md
- path: references/lark-apps-release-get.md
  description: references/lark-apps-release-get.md
- path: references/lark-apps-release-list.md
  description: references/lark-apps-release-list.md
- path: references/lark-apps-session-messages-list.md
  description: references/lark-apps-session-messages-list.md
- path: references/lark-apps-update.md
  description: references/lark-apps-update.md
---
