...
name: lark-okr
version: 1.0.0
description: 飞书 OKR：管理目标与关键结果。查看和编辑 OKR 周期、目标、关键结果、对齐关系、量化指标和进展记录。当用户需要查看或创建 OKR、管理目标和关键结果、查看对齐关系时使用。不负责：待办任务管理（lark-task）、日程/会议安排（lark-calendar）、绩效评估 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-okr-batch-create.md
  description: references/lark-okr-batch-create.md
- path: references/lark-okr-contentblock.md
  description: references/lark-okr-contentblock.md
- path: references/lark-okr-cycle-detail.md
  description: references/lark-okr-cycle-detail.md
- path: references/lark-okr-cycle-list.md
  description: references/lark-okr-cycle-list.md
- path: references/lark-okr-entities.md
  description: references/lark-okr-entities.md
- path: references/lark-okr-image-upload.md
  description: references/lark-okr-image-upload.md
- path: references/lark-okr-indicator-update.md
  description: references/lark-okr-indicator-update.md
- path: references/lark-okr-progress-create.md
  description: references/lark-okr-progress-create.md
- path: references/lark-okr-progress-delete.md
  description: references/lark-okr-progress-delete.md
- path: references/lark-okr-progress-get.md
  description: references/lark-okr-progress-get.md
- path: references/lark-okr-progress-list.md
  description: references/lark-okr-progress-list.md
- path: references/lark-okr-progress-update.md
  description: references/lark-okr-progress-update.md
- path: references/lark-okr-reorder.md
  description: references/lark-okr-reorder.md
- path: references/lark-okr-weight.md
  description: references/lark-okr-weight.md
---
