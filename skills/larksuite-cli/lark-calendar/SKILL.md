...
type: default
references:
- path: references/lark-calendar-agenda.md
  description: references/lark-calendar-agenda.md
- path: references/lark-calendar-create.md
  description: references/lark-calendar-create.md
- path: references/lark-calendar-freebusy.md
  description: references/lark-calendar-freebusy.md
- path: references/lark-calendar-room-find.md
  description: references/lark-calendar-room-find.md
- path: references/lark-calendar-rsvp.md
  description: references/lark-calendar-rsvp.md
- path: references/lark-calendar-schedule-meeting.md
  description: references/lark-calendar-schedule-meeting.md
- path: references/lark-calendar-suggestion.md
  description: references/lark-calendar-suggestion.md
- path: references/lark-calendar-update.md
  description: references/lark-calendar-update.md
---
