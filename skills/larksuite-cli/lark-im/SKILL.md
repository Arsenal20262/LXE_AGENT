...
name: lark-im
version: 1.0.0
description: 飞书即时通讯：收发消息和管理群聊。发送和回复消息、搜索聊天记录、管理群聊成员、上传下载图片和文件（支持大文件分片下载）、管理表情回复、发送应用内/短信/电话加急。当用户需要发消息、查看或搜索聊天记录、下载聊天中的文件、查看群成员、搜索群、创建群聊或话题群、管理标记数据、管理 Feed 置顶（添加/移除/查询置顶会话）、管理标签数据时使用。 Use lark-im for sending, replying, reading and searching messages, cross-chat operations, group management, resource downloads, reactions, feed/flag operations, or user/bot identity switching. Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
- path: references/lark-im-chat-create.md
  description: references/lark-im-chat-create.md
- path: references/lark-im-chat-identity.md
  description: references/lark-im-chat-identity.md
- path: references/lark-im-chat-list.md
  description: references/lark-im-chat-list.md
- path: references/lark-im-chat-messages-list.md
  description: references/lark-im-chat-messages-list.md
- path: references/lark-im-chat-search.md
  description: references/lark-im-chat-search.md
- path: references/lark-im-chat-update.md
  description: references/lark-im-chat-update.md
- path: references/lark-im-feed-group-list-item.md
  description: references/lark-im-feed-group-list-item.md
- path: references/lark-im-feed-group-list.md
  description: references/lark-im-feed-group-list.md
- path: references/lark-im-feed-group-query-item.md
  description: references/lark-im-feed-group-query-item.md
- path: references/lark-im-feed-groups.md
  description: references/lark-im-feed-groups.md
- path: references/lark-im-feed-shortcut-create.md
  description: references/lark-im-feed-shortcut-create.md
- path: references/lark-im-feed-shortcut-list.md
  description: references/lark-im-feed-shortcut-list.md
- path: references/lark-im-feed-shortcut-remove.md
  description: references/lark-im-feed-shortcut-remove.md
- path: references/lark-im-flag-cancel.md
  description: references/lark-im-flag-cancel.md
- path: references/lark-im-flag-create.md
  description: references/lark-im-flag-create.md
- path: references/lark-im-flag-list.md
  description: references/lark-im-flag-list.md
- path: references/lark-im-message-enrichment.md
  description: references/lark-im-message-enrichment.md
- path: references/lark-im-messages-mget.md
  description: references/lark-im-messages-mget.md
- path: references/lark-im-messages-reply.md
  description: references/lark-im-messages-reply.md
- path: references/lark-im-messages-resources-download.md
  description: references/lark-im-messages-resources-download.md
- path: references/lark-im-messages-search.md
  description: references/lark-im-messages-search.md
- path: references/lark-im-messages-send.md
  description: references/lark-im-messages-send.md
- path: references/lark-im-reactions.md
  description: references/lark-im-reactions.md
- path: references/lark-im-threads-messages-list.md
  description: references/lark-im-threads-messages-list.md
---
