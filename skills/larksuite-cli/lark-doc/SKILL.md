...
name: lark-doc
version: 2.0.0
description: 飞书云文档（Docx / Wiki 文档，v2 API）：读取和编辑飞书文档内容。当用户给出文档 URL 或 token，或需要查看、创建、编辑文档、插入或下载文档图片附件时使用。文档中嵌入的电子表格、多维表格、画板，先用本 skill 提取 token 再切到对应 skill。当用户给出 doubao.com 的 /docx/ 或 /wiki/ URL/token 时，也应直接使用本 skill；路由依据是 URL 路径模式和 token，而不是域名。不负责文档评论管理，也不负责表格或 Base 的数据操作。 Use only when the user explicitly requests Feishu, Lark, or LarkSuite workspace operations. Do not use as a replacement for FBA shipment, invoice, customs, logistics, export-tax, MSKU, inventory, sales-analysis, replenishment calculation, or replenishment workflow requests that match a dedicated amazon_fba or replenishment skill.
metadata:
  requires:
    bins:
    - lark-cli
...
type: default
references:
- path: references/lark-doc-create.md
  description: references/lark-doc-create.md
- path: references/lark-doc-fetch.md
  description: references/lark-doc-fetch.md
- path: references/lark-doc-md.md
  description: references/lark-doc-md.md
- path: references/lark-doc-media-download.md
  description: references/lark-doc-media-download.md
- path: references/lark-doc-media-insert.md
  description: references/lark-doc-media-insert.md
- path: references/lark-doc-media-preview.md
  description: references/lark-doc-media-preview.md
- path: references/lark-doc-resource-cover.md
  description: references/lark-doc-resource-cover.md
- path: references/lark-doc-update.md
  description: references/lark-doc-update.md
- path: references/lark-doc-whiteboard.md
  description: references/lark-doc-whiteboard.md
- path: references/lark-doc-xml.md
  description: references/lark-doc-xml.md
- path: references/style/lark-doc-create-workflow.md
  description: references/style/lark-doc-create-workflow.md
- path: references/style/lark-doc-style.md
  description: references/style/lark-doc-style.md
- path: references/style/lark-doc-update-workflow.md
  description: references/style/lark-doc-update-workflow.md
---
