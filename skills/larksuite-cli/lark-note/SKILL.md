...
type: default
references:
- path: references/lark-note-detail.md
  description: references/lark-note-detail.md
- path: references/lark-note-transcript.md
  description: references/lark-note-transcript.md
---
