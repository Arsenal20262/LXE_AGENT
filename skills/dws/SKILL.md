...
upstream:
  ...
  release: v1.0.39
  tag_commit: 91f44a1efddcfb3356f29c19810a245c08f3c104
  source_path: skills/mono
references:
  - path: references/best_practices/01-messaging.md
    description: references/best_practices/01-messaging.md
  - path: references/best_practices/02-task.md
    description: references/best_practices/02-task.md
  - path: references/best_practices/03-meeting.md
    description: references/best_practices/03-meeting.md
  - path: references/best_practices/04-document.md
    description: references/best_practices/04-document.md
  - path: references/best_practices/05-reporting.md
    description: references/best_practices/05-reporting.md
  - path: references/best_practices/06-data-analytics.md
    description: references/best_practices/06-data-analytics.md
  - path: references/best_practices/07-minutes.md
    description: references/best_practices/07-minutes.md
  - path: references/best_practices/08-directory.md
    description: references/best_practices/08-directory.md
  - path: references/best_practices/09-mail.md
    description: references/best_practices/09-mail.md
  - path: references/best_practices/10-minutes-speaker-match.md
    description: references/best_practices/10-minutes-speaker-match.md
  - path: references/best_practices/11-minutes-speaker-correct.md
    description: references/best_practices/11-minutes-speaker-correct.md
  - path: references/best_practices/_common/conventions.md
    description: references/best_practices/_common/conventions.md
  - path: references/best_practices/_common/recipe-conventions.md
    description: references/best_practices/_common/recipe-conventions.md
  - path: references/best_practices/lite-recipes.md
    description: references/best_practices/lite-recipes.md
  - path: references/capability-limits.md
    description: references/capability-limits.md
  - path: references/error-codes.md
    description: references/error-codes.md
  - path: references/field-rules.md
    description: references/field-rules.md
  - path: references/global-reference.md
    description: references/global-reference.md
  - path: references/intent-guide.md
    description: references/intent-guide.md
  - path: references/products/aisearch.md
    description: references/products/aisearch.md
  - path: references/products/aitable-record-ops.md
    description: references/products/aitable-record-ops.md
  - path: references/products/aitable.md
    description: references/products/aitable.md
  - path: references/products/aitable/aitable-attachment.md
    description: references/products/aitable/aitable-attachment.md
  - path: references/products/aitable/aitable-best-practices.md
    description: references/products/aitable/aitable-best-practices.md
  - path: references/products/aitable/aitable-cell-value.md
    description: references/products/aitable/aitable-cell-value.md
  - path: references/products/aitable/aitable-dashboard-chart.md
    description: references/products/aitable/aitable-dashboard-chart.md
  - path: references/products/aitable/aitable-data-analysis-sop.md
    description: references/products/aitable/aitable-data-analysis-sop.md
  - path: references/products/aitable/aitable-error-recovery.md
    description: references/products/aitable/aitable-error-recovery.md
  - path: references/products/aitable/aitable-export-import.md
    description: references/products/aitable/aitable-export-import.md
  - path: references/products/aitable/aitable-field-properties.md
    description: references/products/aitable/aitable-field-properties.md
  - path: references/products/aitable/aitable-field.md
    description: references/products/aitable/aitable-field.md
  - path: references/products/aitable/aitable-filter-sort.md
    description: references/products/aitable/aitable-filter-sort.md
  - path: references/products/aitable/aitable-form.md
    description: references/products/aitable/aitable-form.md
  - path: references/products/aitable/aitable-formula-guide.md
    description: references/products/aitable/aitable-formula-guide.md
  - path: references/products/aitable/aitable-record-create.md
    description: references/products/aitable/aitable-record-create.md
  - path: references/products/aitable/aitable-record-delete.md
    description: references/products/aitable/aitable-record-delete.md
  - path: references/products/aitable/aitable-record-query.md
    description: references/products/aitable/aitable-record-query.md
  - path: references/products/aitable/aitable-record-update.md
    description: references/products/aitable/aitable-record-update.md
  - path: references/products/attendance.md
    description: references/products/attendance.md
  - path: references/products/calendar.md
    description: references/products/calendar.md
  - path: references/products/chat-emoji-list.md
    description: references/products/chat-emoji-list.md
  - path: references/products/chat.md
    description: references/products/chat.md
  - path: references/products/contact.md
    description: references/products/contact.md
  - path: references/products/devdoc.md
    description: references/products/devdoc.md
  - path: references/products/ding.md
    description: references/products/ding.md
  - path: references/products/doc.md
    description: references/products/doc.md
  - path: references/products/doc/doc-block.md
    description: references/products/doc/doc-block.md
  - path: references/products/doc/doc-comment.md
    description: references/products/doc/doc-comment.md
  - path: references/products/doc/doc-create.md
    description: references/products/doc/doc-create.md
  - path: references/products/doc/doc-export.md
    description: references/products/doc/doc-export.md
  - path: references/products/doc/doc-file-ops.md
    description: references/products/doc/doc-file-ops.md
  - path: references/products/doc/doc-info.md
    description: references/products/doc/doc-info.md
  - path: references/products/doc/doc-list.md
    description: references/products/doc/doc-list.md
  - path: references/products/doc/doc-media.md
    description: references/products/doc/doc-media.md
  - path: references/products/doc/doc-permission.md
    description: references/products/doc/doc-permission.md
  - path: references/products/doc/doc-read.md
    description: references/products/doc/doc-read.md
  - path: references/products/doc/doc-search.md
    description: references/products/doc/doc-search.md
  - path: references/products/doc/doc-update.md
    description: references/products/doc/doc-update.md
  - path: references/products/doc/format/doc-jsonml-cookbook.md
    description: references/products/doc/format/doc-jsonml-cookbook.md
  - path: references/products/doc/format/doc-jsonml-schema.md
    description: references/products/doc/format/doc-jsonml-schema.md
  - path: references/products/doc/style/doc-create-workflow.md
    description: references/products/doc/style/doc-create-workflow.md
  - path: references/products/doc/style/doc-style-guideline.md
    description: references/products/doc/style/doc-style-guideline.md
  - path: references/products/doc/style/doc-update-workflow.md
    description: references/products/doc/style/doc-update-workflow.md
  - path: references/products/drive.md
    description: references/products/drive.md
  - path: references/products/mail.md
    description: references/products/mail.md
  - path: references/products/minutes.md
    description: references/products/minutes.md
  - path: references/products/oa.md
    description: references/products/oa.md
  - path: references/products/report.md
    description: references/products/report.md
  - path: references/products/sheet.md
    description: references/products/sheet.md
  - path: references/products/simple.md
    description: references/products/simple.md
  - path: references/products/todo.md
    description: references/products/todo.md
  - path: references/products/wiki.md
    description: references/products/wiki.md
  - path: references/recovery-guide.md
    description: references/recovery-guide.md
  - path: references/url-patterns.md
    description: references/url-patterns.md
---
...
This LXE skill vendors the official DingTalk Workspace CLI mono skill from `DingTalk-Real-AI/dingtalk-workspace-cli` release `v1.0.39`, tag commit `91f44a1efddcfb3356f29c19810a245c08f3c104`, source path `skills/mono`. Preserve `LICENSE` and `NOTICE` with this directory when updating.

## LXE Runtime Rules

- Resolve `SKILL_DIR` as the absolute directory containing this `SKILL.md`; use it in shell commands.
- Before the first DingTalk operation in a task, check `command -v dws`, `dws --version`, and `dws auth status`.
- If `dws` is not installed, not on `PATH`, or not authenticated, stop and report the missing install/authentication step. Do not write credentials, tokens, connector state, or WorkBuddy auth files.
- Run bundled scripts with `uv run --frozen python "$SKILL_DIR/scripts/<script>.py" ...` from the workspace root.
- Put DingTalk downloads, exports, and generated deliverables under `artifacts/dws/`.
...
- **脚本优先**：[scripts/](./scripts/) 下的脚本已封装翻页/轮询/批量逻辑；按 LXE Runtime Rules 使用 `uv run --frozen python "$SKILL_DIR/scripts/<name>.py"` 调用。遇到对应场景（如 AI 表格批量导入导出、AI 应用创建轮询、文档创建后写内容、钉盘目录树等）**优先调用脚本**而非手写多步命令。脚本均支持 `--dry-run` 预览、`--format json` 输出，失败时回退到手动步骤
