...
description: 用户明确提到“菲律宾”，并要求获取、拉取、查询或导出菲律宾商品数据时使用；提到“智汇”时同样适用，例如“导出智汇菲律宾商品”“查询菲律宾库存”“查询智汇菲律宾库存”“下载智汇菲律宾商品资料”或生成商品 Excel/XLSX。仅限商品全量导出，不处理订单、物流、发货、采购、财务报表或独立历史报表。
...
用户的同一请求明确包含“菲律宾”关键词，并命中商品数据意图时，才可归一到本 Skill；“智汇”是可选的平台补充关键词。以下表达属于本 Skill：

- “导出/下载/拉取/整理智汇菲律宾商品”“把智汇菲律宾商品清单导成 Excel/XLSX”；
- “查智汇菲律宾商品 SKU、销量、库存、入库时间、上架时间，并导出文件”；
- “帮我把智汇菲律宾站的商品数据拉下来”“查询菲律宾库存”“生成智汇菲律宾商品表”；
- “导出智汇商品”“下载菲律宾商品资料”“导出商品 Excel/XLSX”“把商品表导出来”（均须由 AI 参数翻译确认目标为菲律宾商品数据）。

只提到“智汇”、不提“菲律宾”，以及依赖上一轮上下文的简短追问，都不要触发本 Skill；这样可以为后续其他平台保留清晰的路由边界。
