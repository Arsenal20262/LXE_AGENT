...
requireText("packages/foundation/desktop-protocol/src/index.ts", /AGENT_PROTOCOL_VERSION\s*=\s*23\s+as const/, "agent protocol must use the JSON-RPC v23 business contract");
