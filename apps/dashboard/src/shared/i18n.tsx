...
export const ZH_TEXT = {
  ...
  conversation: {
    ...
    process: "执行过程",
    processCompleted: (duration: string) => duration ? `已完成，用时 ${duration}` : "已完成",
    ...
    screenshot: "截图",
    tooManyScreenshots: "每轮最多粘贴 5 张截图",
  ...
  models: {
    ...
    cloudModels: "云端模型",
    localModels: "本地模型",
    cloudModelsHint: "使用公司发布的模型配置和 Key；模型与思考强度请在对话栏切换。",
    localModelsHint: "使用本机保存的个人 Key，模型请求仍发送给供应商。",
    cloudModelsEmpty: "公司暂未提供云端模型",
    available: "可用",
    unavailable: "不可用",
    companyCredentialUnavailable: "公司模型凭据不可用",
    companyConfigurationUnavailable: "云端模型配置不可用",
    providers: "模型厂商",
    variants: "模型版本",
    configured: "已配置",
    unconfigured: "未配置",
  ...
  desktop: {
    ...
    cloud: {
      ...
      permission: {
        ...
        unassigned: "未分配",
        labelLocale: "zh-CN",
        contextTitle: "当前设备与权限",
        enrollmentTitle: "设备接入与身份凭据",
        enrollmentHint: "自动识别不配置模型凭据或网页登录；需要这些能力时，请完成设备接入。",
        server: "公司服务器", device: "当前设备", skills: "Skill 范围", features: "桌面功能",
        services: "业务服务", actions: "ERP 操作", unknown: "待查询", empty: "无授权",
        refresh: "重新查询权限", confirm: "确认使用当前设备",
...
export const UI_TEXT: Record<Language, UiText> = {
  ...
  en: {
    ...
    conversation: {
      ...
      historicalImage: "Preview of historical image",
      newTitle: "New chat",
      ...
      process: "Process",
      processCompleted: (duration: string) => duration ? `Completed in ${duration}` : "Completed",
      ...
      tooManyScreenshots: "You can paste at most 5 screenshots per turn",
    ...
    models: {
      ...
      cloudModelsHint: "Uses company-published model settings and keys. Switch models and thinking effort in the conversation composer.",
      localModelsHint: "Uses personal keys saved on this machine. Model requests are still sent to the provider.",
      cloudModelsEmpty: "Your company has not published any cloud models",
      available: "Available",
      unavailable: "Unavailable",
      companyCredentialUnavailable: "Company model credential is unavailable",
      companyConfigurationUnavailable: "Cloud model configuration is unavailable",
      providers: "Providers",
      variants: "Variants",
    ...
    desktop: {
      ...
      cloud: {
        ...
        permission: {
          ...
          labelLocale: "en-US",
          contextTitle: "Current device and permissions",
